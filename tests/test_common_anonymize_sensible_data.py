...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Анна", "anna"),
        ("Άννα", "anna"),
        # FIXME: The fact that the last two inputs have the same output could lead to subtle problems along the line,
        # maybe we should be more careful when removing unwanted characters?
    ],
)
