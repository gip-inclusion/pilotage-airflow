...
SNAPSHOT_FILE = (
    ...
    / "snapshots"
    / "snapshot_table_etp_financed.csv"
)
...
def test_etp_financed_pipeline(mock_get_structures):
    ...
    montant, etp, total_etp, percentage = compute_etp_financed(filtered_company_data, structures_filtered, count_un_etp)
