select
    ...
    asp_benef.nom_departement_structure                                       as nom_departement_af,
    asp_benef.nom_region_structure                                            as nom_region_af,
...
union all
select
    {{ pilo_star(ref('beneficiaires_sorties_v0'),  relation_alias="benef_current_year") }},
...
from
    {{ ref('beneficiaires_sorties_v0') }} as benef_current_year
where benef_current_year.emi_sme_annee = date_part('year', current_date)::INTEGER
union all
select
    {{ pilo_star(ref('beneficiaires_sorties_v0'),  relation_alias="benef_eiti") }},
    null                                           as total_sorties,
    null                                           as total_sorties_emploi_durable,
    null                                           as total_sorties_emploi_transition,
    null                                           as total_sorties_emploi_positives,
...
from
    {{ ref('beneficiaires_sorties_v0') }} as benef_eiti
where
