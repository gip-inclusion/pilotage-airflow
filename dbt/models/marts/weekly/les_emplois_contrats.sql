...
left join {{ source('fluxIAE',"fluxIAE_Salarie") }} salarie
...
where pass_ag.type != 'Agrément PE' and
    pass_ag."date_début" <= ctr.contrat_date_embauche and
    pass_ag.date_fin >= to_date(ctr.contrat_date_sortie_definitive, 'DD/MM/YYYY')
