select
    ...
    org.nom                                                                                                       as "Nom SPIP",
    date_part('year', cel.date_candidature)                                                                       as "Année",
...
where date_part('year', cel.date_candidature) = extract(year from current_date) - 1 and org.type = 'SPIP'
group by
    ...
    org.code_postal,
    org.nom,
    date_part('year', cel.date_candidature)
