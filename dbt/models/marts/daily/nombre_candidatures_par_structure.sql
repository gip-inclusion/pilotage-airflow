...
select
    c."état",
    c.date_candidature,
    c.nombre_de_candidatures, -- nombre de cadndiatures total pour la structure
    prop_cddr.total_candidatures, -- nombre de candidatures total pour cette structure et cet état
