...
left join {{ source('emplois', 'cap_structures') }} as cap_structures on structures."id" = cap_structures."id_structure"
left join {{ source('emplois', 'cap_campagnes') }} as cap_campagnes on cap_structures."id_cap_campagne" = cap_campagnes."id"
